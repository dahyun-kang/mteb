...
text_embedding_eva02 = ModelMeta(
    name="QuanSun/EVA02_CLIP_L_336_psz14_s6B",
    revision="",
    embed_dim=1024, 
    # model_size='small',
    release_date="2024-11-03",
    languages=None,  # supported languages not specified
    loader=partial(EVA02_Wrapper, model_name="QuanSun/EVA02_CLIP_L_336_psz14_s6B"),
    max_tokens=8191,
    open_weights=False,
    n_parameters=None,
    memory_usage=None,
