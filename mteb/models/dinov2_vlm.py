...
class DINOv2_VLM_Wrapper(Wrapper):
    def __init__(self, model_name: str, embed_dim: int | None = None, **kwargs) -> None:
        ...
        # model_root = '/checkpoint/dino/dahyunkang/experiments/1030_metaclipv2mraw_224_vb2_clspatch_iter50K2K'
        model_root = '/checkpoint/dino/cijose/experiments/LiT/cvpr_main_experiments/MetaCLIP_v2_Balanced_090924_Mitigated_Airstore_access_modeITERABLE/ViT-L-14_768d12h12l_224_cls_400000_2000_32768_lr_0.0005_wd_0.2_768_dp_0.0_vb_0_vlp_False_beta1_0.9_beta2_0.98_eps_1e-06_fls_False_quickgelu_bf16'
